...
const createSlider = () => {
  ...
  if (duration.value < 0) {
    alert("Enter minimun value 1 second");
    duration.value = "";
    return;
  }
  ...
  const durationTime = duration.value || 1000;
...
// for showing images after click search button or press enter key
const showImage = () => {
